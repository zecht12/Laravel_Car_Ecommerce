        ...
        <div class="card py-2" style="width: 600px;">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mt-2">
                        <a href="{{ route('password.request') }}" class="fs-6" style="color: #FF6801;">
                            Forgot Password?
                        </a>
                    </div>
                    <button type="submit" class="btn btn-primary w-100 mt-3" style="--bs-btn-color: #ffff; --bs-btn-bg:#FF6801; --bs-btn-border-color: #FF6801; --bs-btn-hover-bg: #e75c00; --bs-btn-hover-border-color: #e75c00;">Login</button>
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('register') }}" class="fs-6" style="color: #FF6801;">
